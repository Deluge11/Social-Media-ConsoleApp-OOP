...
{
    public class PageWithActionPermission : absScrollPage, IAction
    {
        public override string PageName => "Page With Action Permission";
        protected override string EmptyRowsMessage => "There is no Rows";
        public string ActionName => "Add New Row";

        public enPermission ActionPermission => enPermission.Test;
